...
const (
	// Label holds the string label denoting the pathname type in the database.
	Label = "pathname"
	...
	// Table holds the table name of the pathname in the database.
	Table = "pathnames"
	...
	PageStatsColumn = "pathname_page_stats"
)

// Columns holds all SQL columns for pathname fields.
var Columns = []string{
	FieldID,
	FieldName,
}
