...
func (sq *ScreenQuery) First(ctx context.Context) (*Screen, error) {
	...
	if len(sSlice) == 0 {
		return nil, &NotFoundError{screen.Label}
	}
	return sSlice[0], nil
}
...
func (sq *ScreenQuery) Only(ctx context.Context) (*Screen, error) {
	...
	case 0:
		return nil, &NotFoundError{screen.Label}
	default:
		return nil, &NotSingularError{screen.Label}
	}
}
...
func (sq *ScreenQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = &NotSingularError{screen.Label}
	}
	return
}
...
func (sq *ScreenQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	if err := sq.Select(screen.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (sq *ScreenQuery) Clone() *ScreenQuery {
	return &ScreenQuery{
		...
		predicates: append([]predicate.Screen{}, sq.predicates...),
...
func (sq *ScreenQuery) prepareQuery(ctx context.Context) error {
	if sq.path != nil {
...
func (sq *ScreenQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := sq.querySpec()
	return sqlgraph.CountNodes(ctx, sq.driver, _spec)
}

func (sq *ScreenQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (sq *ScreenQuery) querySpec() *sqlgraph.QuerySpec {
...
func (sq *ScreenQuery) sqlQuery() *sql.Selector {
	builder := sql.Dialect(sq.driver.Dialect())
	t1 := builder.Table(screen.Table)
	selector := builder.Select(t1.Columns(screen.Columns...)...).From(t1)
	if sq.sql != nil {
		selector = sq.sql
		selector.Select(selector.Columns(screen.Columns...)...)
	}
...
func (sgb *ScreenGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScreenGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScreenGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScreenGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScreenGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScreenGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScreenGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScreenGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScreenGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScreenGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScreenGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScreenGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScreenGroupBy) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (sgb *ScreenGroupBy) sqlQuery() *sql.Selector {
	selector := sgb.sql
...
func (ss *ScreenSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScreenSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScreenSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScreenSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScreenSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScreenSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScreenSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScreenSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScreenSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScreenSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScreenSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScreenSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{screen.Label}
	default:
		err = fmt.Errorf("ent: ScreenSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScreenSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (ss *ScreenSelect) sqlQuery() sql.Querier {
	selector := ss.sql
